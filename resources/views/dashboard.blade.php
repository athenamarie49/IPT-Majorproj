...
<div class="container" style="background-color: #20B2AA; padding-bottom: 10px;">
  <div class="float-end mt-4">
    <a href="/newpost" class="btn btn-dark">
      <i class="fas fa-money-check-edit"></i> New Post
    </a>
  </div>
  <h1 class="text-gray pt-15 pb-2">Recent Post</h1>
  <hr>
  @foreach($posts as $p)
  @if ($p->user->gender == 'Male')
  <div class="card m-1 mb-3 pb-3 pt-3" style="background-color: lightblue">
  @else
  <div class="card m-5 mb-3 pb-3 pt-3" style="background-color: gray">
  @endif
    <div class="card-body">
